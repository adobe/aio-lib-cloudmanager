...
beforeEach(() => {
  ...
  mockResponseWithMethod('https://cloudmanager.adobe.io/program/1/environment/2/runtime/commerce/cli/', 'POST', {
    status: 201,
    data: {
      test: 'test success data',
    },
  })
  fetchMock.mock('https://cloudmanager.adobe.io/program/3/environment/4/runtime/commerce/cli/', 403)
})
